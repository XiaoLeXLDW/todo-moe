...
最新候选为 [0.3.0 Dev vc46](0.3.0-dev-vc46-2026-09-15.md)，源码 `5367c455`，已在 USB `zizhan` 从 vc45 覆盖安装。vc46 修复失败原子性、跨分区拖动、删除/完成撤销槽位、左滑动作及项目操作层玻璃；295 files / 2911 tests 全通过，真机左/右滑、多选、删除/立即撤销与分组弹层通过。[Dev vc12](0.1.0-dev-vc12-2026-09-12.md)及更早记录是历史快照，不再代表当前候选。
...
**更新：2026-09-15。目标手机当前安装 Dev vc46；最新已构建 Dev 也是 vc46；v1.0 未放行，本轮不发布 Release。** 早期 vc12 与 `5a36c0b1b7b4091cbff6c839676dff1fa26e6a8a` 的 CI 结果仅作历史证据，不沿用到本轮源码。见[详细回读](../../CI-VALIDATION-20260911.md)。用户明确本轮 local-only，不要求为验收启用任务同步。
