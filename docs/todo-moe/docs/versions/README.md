...
最新候选为 [0.2.0 Dev vc40](0.2.0-dev-vc40-2026-09-14.md)，源码 `9018580b`，已构建并从 vc37 覆盖安装到目标手机；R01 修复后同手势复测通过。[Dev vc12](0.1.0-dev-vc12-2026-09-12.md)及更早记录是历史快照，不再代表当前候选。
...
**更新：2026-09-14。目标手机当前安装 Dev vc40；最新已构建 Dev 也是 vc40；v1.0 未放行。** 早期 vc12 与 `5a36c0b1b7b4091cbff6c839676dff1fa26e6a8a` 的 CI 结果仅作历史证据，不沿用到本轮源码。见[详细回读](../../CI-VALIDATION-20260911.md)。用户明确本轮 local-only，不要求为验收启用任务同步。
