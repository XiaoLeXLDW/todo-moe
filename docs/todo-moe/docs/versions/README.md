...
最新候选为 [0.3.0 Dev vc45](0.3.0-dev-vc45-2026-09-14.md)，源码 `53ff5f7c`，已从 vc44 覆盖安装。vc45 让夸张档使用独立的 52/96 片远距离碎裂、2.65 倍完整大勾和 112dp 清单徽章，增强与触感保持不变；295 files / 2898 tests 全通过，目标手机 4 轮任务＋清单叠加演示 jank 1.62%、Missed Vsync 0。[Dev vc12](0.1.0-dev-vc12-2026-09-12.md)及更早记录是历史快照，不再代表当前候选。
...
**更新：2026-09-14。目标手机当前安装 Dev vc45；最新已构建 Dev 也是 vc45；v1.0 未放行。** 早期 vc12 与 `5a36c0b1b7b4091cbff6c839676dff1fa26e6a8a` 的 CI 结果仅作历史证据，不沿用到本轮源码。见[详细回读](../../CI-VALIDATION-20260911.md)。用户明确本轮 local-only，不要求为验收启用任务同步。
