...
最新候选为 [0.3.0 Dev vc44](0.3.0-dev-vc44-2026-09-14.md)，源码 `46f0174b`，已从 vc43 覆盖安装。vc44 修复预览取消/撤销后的绿色勾号残留，并让外观、动画与触感恢复原设置页卡片结构和统一选择按钮；295 files / 2890 tests 全通过，目标手机的正常与快速取消均显示空框。[Dev vc12](0.1.0-dev-vc12-2026-09-12.md)及更早记录是历史快照，不再代表当前候选。
...
**更新：2026-09-14。目标手机当前安装 Dev vc44；最新已构建 Dev 也是 vc44；v1.0 未放行。** 早期 vc12 与 `5a36c0b1b7b4091cbff6c839676dff1fa26e6a8a` 的 CI 结果仅作历史证据，不沿用到本轮源码。见[详细回读](../../CI-VALIDATION-20260911.md)。用户明确本轮 local-only，不要求为验收启用任务同步。
