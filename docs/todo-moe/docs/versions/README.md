...
最新正式版为 [0.3.1 Stable vc50](0.3.1-release-candidate-vc50-2026-09-16.md)，收录 [0.3.0 Dev vc49](0.3.0-dev-vc49-2026-09-16.md) 及此前 PR #12 修复。UTC Core 3876 pass / 8 skip、Mobile 296 files / 2923 tests、PR Checks 和 USB `zizhan` 归档→重新激活闭环均通过；正式工作流 `35064591234` 已从合并提交 `b8ac5d62` 重建、签名并公开发布。[Dev vc12](0.1.0-dev-vc12-2026-09-12.md)及更早记录是历史快照，不再代表当前版本。
