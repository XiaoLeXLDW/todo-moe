...
最新候选为 [0.3.0 Dev vc47](0.3.0-dev-vc47-2026-09-15.md)，源码 `414976df`，已在 USB `zizhan` 从 vc46 覆盖安装。vc47 将底部“清单”栏目项目卡片统一为手指向左显示“复制＋删除”、向右无动作，并与任务行复用相同轨道、样式和动画；296 files / 2913 tests 及真机方向、同宽同间隔通过。[Dev vc12](0.1.0-dev-vc12-2026-09-12.md)及更早记录是历史快照，不再代表当前候选。
...
**更新：2026-09-15。目标手机当前安装 Dev vc47；最新已构建 Dev 也是 vc47；v1.0 未放行，本轮不发布 Release。** 早期 vc12 与 `5a36c0b1b7b4091cbff6c839676dff1fa26e6a8a` 的 CI 结果仅作历史证据，不沿用到本轮源码。见[详细回读](../../CI-VALIDATION-20260911.md)。用户明确本轮 local-only，不要求为验收启用任务同步。
