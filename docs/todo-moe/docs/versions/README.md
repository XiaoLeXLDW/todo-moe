...
最新候选为 [0.3.0 Dev vc42](0.3.0-dev-vc42-2026-09-14.md)，源码 `9b842993`，已从 vc41 覆盖安装到目标手机。用户接受 vc41 触感，但否决圆圈/射线动画；vc42 改为勾号描出与连贯收起，156 项回归、APK 校验及真机设置预览通过，主观观感待用户确认。[Dev vc12](0.1.0-dev-vc12-2026-09-12.md)及更早记录是历史快照，不再代表当前候选。
...
**更新：2026-09-14。目标手机当前安装 Dev vc42；最新已构建 Dev 也是 vc42；v1.0 未放行。** 早期 vc12 与 `5a36c0b1b7b4091cbff6c839676dff1fa26e6a8a` 的 CI 结果仅作历史证据，不沿用到本轮源码。见[详细回读](../../CI-VALIDATION-20260911.md)。用户明确本轮 local-only，不要求为验收启用任务同步。
