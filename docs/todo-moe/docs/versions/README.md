...
最新正式候选为 [0.3.1 Stable vc50](0.3.1-release-candidate-vc50-2026-09-16.md)，收录 [0.3.0 Dev vc49](0.3.0-dev-vc49-2026-09-16.md) 及此前 PR #12 修复。UTC Core 3876 pass / 8 skip、Mobile 296 files / 2923 tests、PR Checks 和 USB `zizhan` 归档→重新激活闭环均通过；正式 APK 必须从合并后的批准 SHA 重新构建与签名。[Dev vc12](0.1.0-dev-vc12-2026-09-12.md)及更早记录是历史快照，不再代表当前候选。
...
**更新：2026-09-16。目标手机当前安装 Dev vc49；正式候选为 0.3.1 / vc50，用户已批准合并、正式签名和公开发布；v1.0 仍未放行。** 早期 vc12 与 `5a36c0b1b7b4091cbff6c839676dff1fa26e6a8a` 的 CI 结果仅作历史证据，不沿用到本轮源码。见[详细回读](../../CI-VALIDATION-20260911.md)。用户明确本轮 local-only，不要求为验收启用任务同步。
...
|---|---|---|---|---|
| [0.3.1 Stable vc50 发布候选](0.3.1-release-candidate-vc50-2026-09-16.md) | 0.3.1 / stable / vc50 | 待以 PR #12 合并后的批准 SHA 固定 | 必须由受控工作流重新构建和正式签名 | Dev vc49 与 PR Checks 已放行；正式产物、tag 和 Release 待工作流回读 |
