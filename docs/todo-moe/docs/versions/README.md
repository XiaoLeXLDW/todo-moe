...
最新候选为 [0.3.0 Dev vc48](0.3.0-dev-vc48-2026-09-16.md)，源码 `81096a17`，已在 USB `zizhan` 从 vc47 覆盖安装。vc48 修复完成 Toast 优先级、项目文件夹/标签异步会话竞态和日期敏感夹具；保留 vc47 的单向项目滑动，并在真机确认详情玻璃层、完成撤销与数据恢复。UTC Core 3869 pass / 8 skip、Mobile 296 files / 2920 tests 通过。[Dev vc12](0.1.0-dev-vc12-2026-09-12.md)及更早记录是历史快照，不再代表当前候选。
...
**更新：2026-09-16。目标手机当前安装 Dev vc48；最新已构建 Dev 也是 vc48；v1.0 未放行，本轮不发布 Release。** 早期 vc12 与 `5a36c0b1b7b4091cbff6c839676dff1fa26e6a8a` 的 CI 结果仅作历史证据，不沿用到本轮源码。见[详细回读](../../CI-VALIDATION-20260911.md)。用户明确本轮 local-only，不要求为验收启用任务同步。
